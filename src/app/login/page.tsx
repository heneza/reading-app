    ...
    <div className="mx-auto max-w-sm">
      ...
      {isConfirmationNotice ? (
        <div className="space-y-3">
          <Link
            href="/login"
            className="block w-full rounded bg-brand py-2 text-center font-medium text-white hover:opacity-90"
          >
        ...
        <form action={signup} className="space-y-3">
          <div>
            <div className="relative">
              ...
              <input name="username" required autoCapitalize="none" autoComplete="username" autoCorrect="off" placeholder="username" defaultValue={searchParams.username ?? ''} className="w-full rounded border border-slate-300 py-2 pl-7 pr-3" />
            </div>
